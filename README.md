...
基于 CrewAI 、AIPy 的微信公众号自动化工具软件，自动获取抖音、微博等平台热点，生成**高时效（实时）**、高质量、排版酷炫的文章并发布到微信公众号。👉[高大上文章排版预览](#模板发布效果预览)
...
- use_search_service：作为一种搜索体验扩展（缓存本地优先使用），成功率较低，默认False即可
